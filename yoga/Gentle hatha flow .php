    ...
    <div class="@container">
        <div class="@[480px]:p-4">
            <div class="flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 @[480px]:rounded-xl items-center justify-center p-4"
                data-alt="A person in a calm yoga pose in a serene, natural forest setting."
                ...
                <div class="flex flex-col gap-4 text-center">
                    <h1
                        ...
                        Gentle Hatha Flow</h1>
                    <h2
                        class="text-white text-sm font-normal leading-normal @[480px]:text-base @[480px]:font-normal @[480px]:leading-normal max-w-lg mx-auto">
                        Find balance and peace through gentle, mindful movement. Reconnect with your
                        body and calm your mind in this soothing session.</h2>
                </div>
                <div class="flex flex-col sm:flex-row items-center gap-4">
                    <button
                        class="flex w-full sm:w-auto min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-primary text-[#11221c] text-sm font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em]">
                        <span class="truncate">Join Session</span>
                    </button>
                    <a class="flex items-center gap-2 text-white text-sm font-medium hover:text-primary transition-colors"
                        href="#">
    ...
    <div class="pb-3">
        <div class="flex border-b border-[#326755] px-4 gap-8">
            <a class="flex flex-col items-center justify-center border-b-[3px] border-b-primary text-white pb-[13px] pt-4"
                href="#">
                <p class="text-white text-sm font-bold leading-normal tracking-[0.015em]">Session
                    Overview</p>
            </a>
            <a class="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#92c9b7] pb-[13px] pt-4"
                href="#">
                <p class="text-[#92c9b7] text-sm font-bold leading-normal tracking-[0.015em]">Pose
                    Guide</p>
            </a>
            <a class="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#92c9b7] pb-[13px] pt-4"
                href="#">
                <p class="text-[#92c9b7] text-sm font-bold leading-normal tracking-[0.015em]">
                    Benefits</p>
            </a>
        </div>
    </div>
    ...
    <div class="p-4 flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-2">
                ...
                <p class="text-[#92c9b7] leading-relaxed">This Gentle Hatha Flow is designed to
                    create a peaceful and nurturing space for you to connect with your body and
                    breath. We'll move through a series of foundational yoga poses at a slow,
                    deliberate pace, focusing on proper alignment and mindful transitions. This
                    session is perfect for beginners or anyone looking to unwind, release tension,
                    and cultivate a sense of inner calm. Expect to leave feeling refreshed,
                    centered, and more flexible.</p>
            </div>
            <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-wrap gap-2">
                <span
                    class="inline-block bg-[#23483c] text-primary rounded-full px-3 py-1 text-sm font-semibold">#Relaxation</span>
                <span
                    class="inline-block bg-[#23483c] text-primary rounded-full px-3 py-1 text-sm font-semibold">#Mindfulness</span>
                <span
                    class="inline-block bg-[#23483c] text-primary rounded-full px-3 py-1 text-sm font-semibold">#Flexibility</span>
            </div>
        </div>
    </div>
    ...
    <div class="px-4 flex flex-col gap-4">
        ...
        <details class="group bg-[#1a352a] rounded-lg p-4 cursor-pointer">
            ...
            <div class="mt-4 text-[#92c9b7] leading-relaxed">
                <p>Stand tall with feet together, grounding through all four corners of your feet.
                    Engage your leg muscles, lengthen your spine, and relax your shoulders down and
                    back. This pose improves posture and creates a sense of stability.</p>
            </div>
        </details>
        <details class="group bg-[#1a352a] rounded-lg p-4 cursor-pointer">
            <summary class="flex items-center justify-between font-medium text-white">
            ...
            <div class="mt-4 text-[#92c9b7] leading-relaxed">
                <p>Start on your hands and knees. Inhale as you drop your belly and look up (Cow),
                    and exhale as you round your spine and tuck your chin (Cat). This gentle flow
                    warms up the spine and relieves back tension.</p>
            </div>
        </details>
        <details class="group bg-[#1a352a] rounded-lg p-4 cursor-pointer">
            <summary class="flex items-center justify-between font-medium text-white">
            ...
            <div class="mt-4 text-[#92c9b7] leading-relaxed">
                <p>From hands and knees, sit back on your heels and fold forward, resting your
                    forehead on the mat. This is a restorative pose that gently stretches the hips
                    and back while calming the mind.</p>
            </div>
        </details>
    </div>
    ...
    <div class="p-4 flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-[#1a352a] p-6 rounded-lg border border-[#326755]">
                ...
                <p class="text-[#92c9b7] italic mb-4">"A wonderfully gentle session that still
                    provides a great stretch. The instructor's voice is incredibly soothing. Highly
                    recommend!"</p>
                <p class="text-white font-bold">- Riya sharma</p>
            </div>
        </div>

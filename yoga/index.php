...
<div class="content">
<!-- TopNavBar -->
<header class="header border-white/10 dark:border-b-[#23482f]">
...
<h2 class="text-white txt-xl">ForestSoul</h2>
</div>
<div class="hidden-mobile flex-1 justify-end gap-xl">
<div class="nav">
<a class="text-white txt-sm font-medium" href="#">Yoga</a>
<a class="text-white txt-sm font-medium" href="#">Meditation</a>
<a class="text-white txt-sm font-medium" href="#">Therapy</a>
<a class="text-white txt-sm font-medium" href="#">Donate</a>
</div>

...
<title>Overcoming Anxiety Details</title>
...
<header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-white/10 dark:border-b-[#23483c] px-4 md:px-10 py-3">
...
<a class="text-gray-600 dark:text-white text-sm font-medium leading-normal" href="#">Donate</a>
</div>
...
<button class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-gray-200 dark:bg-[#23483c] text-black dark:text-white text-sm font-bold leading-normal tracking-[0.015em]">
...
<div class="flex flex-1 gap-3 rounded-lg border border-gray-200 dark:border-[#326755] bg-background-light dark:bg-[#19332b] p-4 flex-col">
...
<a class="flex flex-col items-center justify-center border-b-[3px] border-b-primary text-black dark:text-white pb-[13px] pt-4" href="#">
<p class="text-sm font-bold leading-normal tracking-[0.015em]">Program Details</p>
</a>
<a class="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-gray-500 dark:text-[#92c9b7] pb-[13px] pt-4" href="#">
...
<p class="text-black dark:text-white text-sm font-normal leading-normal">Learn to anchor yourself in the present moment and calm your nervous system through conscious, controlled breathing techniques.</p>
</div>
<div class="col-span-2 grid grid-cols-subgrid border-t border-gray-200 dark:border-t-[#326755] py-5">
<p class="text-gray-500 dark:text-[#92c9b7] text-sm font-normal leading-normal">Body Scan Meditation</p>
<p class="text-black dark:text-white text-sm font-normal leading-normal">Develop a deeper connection with your body, identify areas of tension, and learn to release physical stress associated with anxiety.</p>
</div>
<div class="col-span-2 grid grid-cols-subgrid border-t border-gray-200 dark:border-t-[#326755] py-5">
<p class="text-gray-500 dark:text-[#92c9b7] text-sm font-normal leading-normal">Cognitive Reframing</p>
<p class="text-black dark:text-white text-sm font-normal leading-normal">Understand and reshape anxious thought patterns, challenge negative self-talk, and cultivate a more balanced perspective for greater mental clarity.</p>
</div>
<div class="col-span-2 grid grid-cols-subgrid border-t border-gray-200 dark:border-t-[#326755] py-5">
<p class="text-gray-500 dark:text-[#92c9b7] text-sm font-normal leading-normal">Visualization</p>
<p class="text-black dark:text-white text-sm font-normal leading-normal">Practice guided imagery to create a mental sanctuary, reduce feelings of overwhelm, and foster a state of deep relaxation.</p>
</div>
</div>
</div>
...
<div class="flex flex-col gap-4 rounded-lg border border-gray-200 dark:border-[#326755] bg-background-light dark:bg-[#19332b] p-6">
<div class="flex items-center gap-4">
<img class="h-12 w-12 rounded-full object-cover" data-alt="A portrait of a smiling woman." src="https://lh3.googleusercontent.com/aida-public/AB6AXuA7Shv3egvONFBKUwqfM5KdGSnxXV1hr_oD8Hmc0wn0xAJAIQJE2xpVRwkwiCaqk1EGrDILk2MiowFdu5hl0Gu25guwBv7ET4OCTuC_grsv_b15Ifg-AiCCRTjFup6l3ex8v-pQ6gAI5d96IjTI0oiee1YEIwej28lK_afW8zRq1IILs9tcL1Ffcmkpo-SeUGOVMaBohAV3zh5LGksdylFv9_qYAWxWBpKEDrjdlhUhjJ-GdQiKRKAzd2Wzy1R_IC51_sq_yCSJnkw"/>
<div>
...
<blockquote class="text-black dark:text-white/90 italic">"This program was a game-changer. The daily practices were short but incredibly effective. I feel more in control of my thoughts and much calmer throughout the day."</blockquote>
</div>
<div class="flex flex-col gap-4 rounded-lg border border-gray-200 dark:border-[#326755] bg-background-light dark:bg-[#19332b] p-6">
<div class="flex items-center gap-4">
<img class="h-12 w-12 rounded-full object-cover" data-alt="A portrait of a man with a beard, looking thoughtfully at the camera." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAeKxF9by1cfHs0at98Db1a0zhHFSvF-Eskzis9IVEiTcXfnkYuOnxsVylTS8BOQ1Ob8e83uNa4RCFEqPxFX0YKQ6Sul5mzfwAtpMSpFgUYvtgLjRs84DM8S0rhKVL_hGQzuO9TxHRn3k0xD_mRcQzlUtKkU7o-r1vXh39rQl_K1vs4IbKD_SuFKDjR-OQA7-96hq3NhMAGEauEj73K0BZYJA6YDtkCTzDxm3EXKXQ23M15sOkHcRnVEuqSMZmu_enzYvpq-USYV5w"/>
<div>
<p class="font-bold text-black dark:text-white">Michael R.</p>
<p class="text-sm text-gray-500 dark:text-[#92c9b7]">Program Participant</p>
</div>
</div>
<blockquote class="text-black dark:text-white/90 italic">"I was skeptical at first, but the week-by-week structure made it so easy to follow. The body scan meditations helped me release so much tension I didn't even know I was holding."</blockquote>
</div>
</div>
</div>
<div class="space-y-6 p-4">
...
<p class="mt-4 text-gray-600 dark:text-[#92c9b7]">Not at all! This program is designed for all levels, from complete beginners to those looking to deepen their existing practice. We guide you every step of the way.</p>
</details>
<details class="group rounded-lg bg-gray-100 dark:bg-[#19332b] p-4">
<summary class="flex cursor-pointer items-center justify-between text-black dark:text-white font-medium">
...
<p class="mt-4 text-gray-600 dark:text-[#92c9b7]">Life happens! You can always go back to a previous day's session. The program is flexible to fit your schedule, though consistency is encouraged for the best results.</p>
</details>
<details class="group rounded-lg bg-gray-100 dark:bg-[#19332b] p-4">
<summary class="flex cursor-pointer items-center justify-between text-black dark:text-white font-medium">
...
<p class="mt-4 text-gray-600 dark:text-[#92c9b7]">All you need is a quiet space where you won't be disturbed for about 15 minutes, and a device to listen to the guided meditations. Headphones are recommended but not required.</p>
</details>
</div>
</div>
<div class="mt-10 flex flex-col items-center justify-center gap-4 rounded-xl bg-gray-100 dark:bg-[#19332b] p-8 text-center">
<h3 class="text-2xl font-bold text-black dark:text-white">Ready to Find Your Inner Peace?</h3>
<p class="max-w-md text-gray-600 dark:text-[#92c9b7]">Join our community and start your journey to a calmer, more resilient you. Your path to overcoming anxiety begins with a single step.</p>
<button class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 bg-primary text-background-dark text-base font-bold leading-normal tracking-[0.015em]">

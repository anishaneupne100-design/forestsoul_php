...
<body class="body">
            ...
            <div class="row gap-sm">
                <?php if ($isLoggedIn): ?>
                    ...
                    <div class="relative" id="user-menu-container">
                        ...
                        <div class="absolute right-0 top-full mt-2 w-48 rounded-lg surface shadow-lg border border-border-light dark:border-border-dark hidden z-50"
                            id="user-dropdown">
                            <div class="py-2">
                                <a href="<?php echo url('profile'); ?>"
                                    class="row gap-2 px-4 py-2 txt-sm txt hover:bg-primary/10 transition-colors">
                                    <span class="material-symbols-outlined" style="font-size: 18px;">person</span>
                                    Profile
                                </a>
                                <a href="<?php echo url('user_progress'); ?>"
                                    class="row gap-2 px-4 py-2 txt-sm txt hover:bg-primary/10 transition-colors">
                                    <span class="material-symbols-outlined" style="font-size: 18px;">trending_up</span>
                                    My Progress
                                </a>
                                <a href="<?php echo url('questionnaire'); ?>"
                                    class="row gap-2 px-4 py-2 txt-sm txt hover:bg-primary/10 transition-colors">
                                ...
                                <?php if (Auth::isAdmin() || Auth::isStaff()): ?>
                                    ...
                                    <a href="<?php echo url('staff'); ?>"
                                        ...
                                        <span class="material-symbols-outlined"
                                            style="font-size: 18px;">admin_panel_settings</span>
                                        Staff Panel
                                    </a>
                                <?php endif; ?>
                                <?php if (Auth::isAdmin()): ?>
                                    <a href="<?php echo url('admin_donation'); ?>"
                                        class="row gap-2 px-4 py-2 txt-sm txt hover:bg-primary/10 transition-colors">
                                        <span class="material-symbols-outlined"
                                            style="font-size: 18px;">volunteer_activism</span>
                                        Manage Donations
                                    </a>
                                <?php endif; ?>
                                <hr class="my-2 border-border-light dark:border-border-dark">
                                <a href="<?php echo url('logout'); ?>"
                                    class="row gap-2 px-4 py-2 txt-sm text-red-500 hover:bg-red-500/10 transition-colors">
    ...
    <div class="md:hidden fixed inset-0 bg-black/50 z-40 hidden" id="mobile-menu-overlay">
        <div class="absolute right-0 top-0 h-full w-64 surface shadow-xl transform transition-transform"
            id="mobile-menu">
            <div class="col h-full">
                ...
                <nav class="col gap-1 px-4 flex-1">
                    ...
                    <a href="<?php echo url('meditation'); ?>"
                        class="row gap-3 px-4 py-3 txt rounded-lg hover:bg-primary/10">
                    ...
                    <a href="<?php echo url('donation'); ?>"
                        class="row gap-3 px-4 py-3 txt rounded-lg hover:bg-primary/10">
                        <span class="material-symbols-outlined">volunteer_activism</span>
                        Donate
                    </a>
                    <a href="<?php echo url('community'); ?>"
                        class="row gap-3 px-4 py-3 txt rounded-lg hover:bg-primary/10">

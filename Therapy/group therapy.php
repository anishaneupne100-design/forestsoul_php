                ...
                <div class="content">
                    ...
                    <div class="row flex-col lg:flex-row gap-xl px-4">
                        ...
                        <div class="w-full lg:w-2/3 col gap-xl">
                            <!-- Header Image -->
                            <div class="img-cover min-h-80 col justify-end p-6"
                            ...
                            <div class="col gap-md">
                                ...
                                <p class="txt-2 txt-md leading-relaxed">
                                    This group provides a supportive and collaborative environment for individuals to
                                    explore and develop effective strategies for managing stress. Through shared
                                    experiences and professional guidance, you will learn practical skills to reduce
                                    anxiety, improve resilience, and enhance your overall well-being. We focus on
                                    cognitive-behavioral techniques, mindfulness practices, and open discussion to
                        ...
                        <div class="w-full lg:w-1/3">
                            <div class="sticky top-24 card">
                                ...
                                <p class="txt-2 txt-sm text-center mt-3">Limited spots available. Register now to secure
                                    your place.</p>
                            </div>
                        </div>
                    </div>

...
<form id="login-form" class="mt-8 col gap-md">
    ...
    <div class="col gap-2">
        <div class="between">
            ...
            <a class="txt-sm font-medium text-primary hover:underline" href="<?php echo url('auth/forgot-password.php'); ?>">Forgot Password?</a>
        </div>
...
<div class="grid grid-cols-2 gap-sm">
    <button class="btn-ghost h-11 gap-2" onclick="showToast('Google login coming soon!', 'info')">
    ...
    <button class="btn-ghost h-11 gap-2" onclick="showToast('Facebook login coming soon!', 'info')">
